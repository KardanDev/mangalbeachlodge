import { aJ as generateCspDigest, a7 as spreadAttributes, ba as unescapeHTML, a1 as renderTemplate, bb as removeBase, b8 as isRemotePath, az as unflatten, A as AstroError, bc as UnknownContentCollectionError, b5 as object, bd as date, be as array, b7 as string } from './sequence_DObSEAM1.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_JyJVnkkE.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (store.hasCollection(collection)) {
      const { default: imageAssetMap } = await import('./content-assets_CzvYUI_6.mjs');
      const result = [];
